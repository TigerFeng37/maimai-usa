...
const SERVER_BASE_URL = import.meta.env.VITE_SERVER_BASE_URL || import.meta.env.VITE_API_BASE_URL?.replace('/api', '') || 'http://maimai-usa-production.up.railway.app:3001'
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://maimai-usa-production.up.railway.app:3001/api'
